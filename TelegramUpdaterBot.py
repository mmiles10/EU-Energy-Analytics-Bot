...
def describe_delivery_error(exc):
    message = str(exc)
    if TOKEN:
    ...
    if report:
        ...
        if should_send:
            ...
            try:
                ...
                print(f"⚠️  Failed to send text report; state not updated: {describe_delivery_error(e)}")
                return
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            print(f"Error: {describe_delivery_error(e)}")
